...
3. Leave the version empty to use the value from [`VERSION`](VERSION), or enter an explicit version without a leading `v`.
4. Enable **pre-release** only for alpha and beta builds.
5. Run the workflow.
